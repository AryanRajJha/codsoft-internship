...
greeting_label = tk.Label(app, text="Welcome! Enter your task below:")
...
delete_button = tk.Button(app, text="Delete Task", width=48, command=delete_task)
delete_button.pack(pady=5)

clear_all_button = tk.Button(app, text="Clear All", width=48, command=clear_all_tasks)
